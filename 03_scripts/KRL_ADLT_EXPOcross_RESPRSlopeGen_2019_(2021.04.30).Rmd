...
dSlopes$CorrWeightSlope <- abs(dSlopes$CorrWeightSlope)
...
slopeplot3 <- ggplot(dSlopes, aes(Treatment, CorrWeightSlope)) +
            ...
            xlab("Treatment") +
            ylab("µg O2 h-1 g-1") +
            ggtitle("Corrected Oxygen Consumption Slopes by Treatment (Oxygen (µg)/hr per Krill gram)") +
            theme_bw()
...
write.csv(dSlopes.summary, "KRL_ADLT_EXPOcross_dSlopeSummaryStats_2021.05.04.csv")
```
