...
dRESP <- read_csv(here::here("data_raw","KRILL_Resp_alltrials.csv"))
write_meta_template(dRESP, here::here("data_raw","KRILL_Resp_alltrials.csv"),
                            embedded = TRUE)
...
dRESPanimal <- read_csv(here::here("data_raw","RespirometryTrials_all.Animal.Info.csv"))
dRESPanimal <- droplevels(filter(dRESPanimal, Treatment != "AMB"))
write_meta_template(dRESPanimal, here::here("data_raw","RespirometryTrials_all.Animal.Info.csv"),
                            embedded = TRUE)
...
dRESPmsr$krilldensity <- ifelse(dRESPmsr$MOATS=="blank", 0, 
                                (dRESPmsr$Size) * 0.001)


dRESPmsr$unique_vialVol <- 0.02806 - dRESPmsr$krilldensity
oxygen <- dRESPmsr$unique_vialVol * dRESPmsr$actualDOmg   
